...
@section('title','Fekete kártyák')

@section('content')
    <h2>Fekete kártyák - <button class="btn btn-default btn-lg" data-toggle="modal" data-target="#add-card"><i class="fa fa-plus"></i> Új kártya</button></h2>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('cards.add') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <p>Ahova BLANK kell, oda azt írd, hogy &lt;blank&gt;</p>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>{{ implode("___", json_decode($card->text)) }}</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Mégse</button>
